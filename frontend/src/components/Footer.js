        ...
        <div className="bc-footer__grid">
          ...
          <div className="bc-footer__col bc-footer__col--brand">
            ...
            <div className="bc-footer__social">
              <a href="https://www.facebook.com/" className="bc-footer__social-icon" aria-label="Facebook" title="Facebook">
              ...
              <a href="https://www.instagram.com/" className="bc-footer__social-icon" aria-label="Instagram" title="Instagram">
              ...
              <a href="https://twitter.com/" className="bc-footer__social-icon" aria-label="Twitter" title="Twitter">
